...
public interface BoardService {
    GlobalResultDto boardSave(BoardWriteRequestDto boardWriteRequestDto, Long idFromToken);

     GlobalResultDto updateWrite(BoardReUpdateRequestDto boardReUpdateRequestDto);

     BoardOneResponseDto boardOne(Long boardId, String token, HttpServletRequest request, HttpServletResponse response);
