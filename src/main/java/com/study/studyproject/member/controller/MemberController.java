...
public class MemberController {
    ...
    public ResponseEntity<UserInfoResponseDto> userInfo(@Parameter(hidden = true) @AuthUser UserDetailsImpl userDetails) {
    ...
    public ResponseEntity<GlobalResultDto> userInfoUpdate(@RequestBody @Validated MemberUpdateResDto memberUpdateResDto,@Parameter(hidden = true) @AuthUser UserDetailsImpl userDetails ) {
